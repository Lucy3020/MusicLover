...
public class PlaylistAdapterRecyclerView extends RecyclerView.Adapter<PlaylistAdapterRecyclerView.ViewHolder> {
    ...
    public PlaylistAdapterRecyclerView(int layoutHolder, int tvName, int tvNumSongs, int ivImage, ArrayList<Playlist> playlistItems, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Playlist currentPlaylist = playlistItems.get(position);
